...
namespace UniCast.LicenseServer.Services
{
    ...
    public class LicenseService : ILicenseService
    {
        ...
        private async Task<string> SignLicenseAsync(LicenseData license)
        {
            ...
            // Client formatina uygun signable content
            ...
            sb.Append('|');
            sb.Append(license.LicenseeName);
            sb.Append('|');
            sb.Append(license.LicenseeEmail);
            sb.Append('|');
            sb.Append(license.IssuedAtUtc.ToString("O"));
            sb.Append('|');
            sb.Append(license.ExpiresAtUtc.ToString("O"));
            sb.Append('|');
            sb.Append(license.SupportExpiryUtc.ToString("O"));
            sb.Append('|');
            sb.Append(license.MaxMachines);
